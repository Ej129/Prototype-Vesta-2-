                ...
                <div className="flex items-center space-x-2">
                    <div className="relative" ref={downloadButtonRef}>
                     ...
                     {isEditing ? (
                        ...
                        <button onClick={() => setIsEditing(true)} className="flex items-center px-4 py-2 bg-light-card dark:bg-dark-card border border-border-light dark:border-border-dark rounded-lg text-secondary-text-light dark:text-secondary-text-dark hover:bg-gray-200 dark:hover:bg-dark-sidebar transition text-sm font-semibold focus:ring-2 focus:ring-primary-blue">
                            Edit Manually
                        </button>
                    )}
                    <button id="auto-fix-button" ref={autoFixRef} onClick={handleAutoFix} disabled={isImproving || isEditing} className="relative flex items-center px-4 py-2 btn-primary text-white font-bold rounded-lg transition text-sm disabled:opacity-50">
