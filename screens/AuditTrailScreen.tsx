...
import { NavigateTo, Screen, User, AuditLog } from '../types';
...
const AuditTrailScreen: React.FC<AuditTrailScreenProps> = ({ navigateTo, currentUser, onLogout, logs }) => {
  ...
  return (
    <SidebarMainLayout navigateTo={navigateTo} activeScreen={Screen.AuditTrail} currentUser={currentUser} onLogout={onLogout}>
